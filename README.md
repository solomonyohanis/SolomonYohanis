...
- Windows Server 2019 / Windows 10 / Windows 11
- Oracle VirtualBox — VM setup and internal networking
- DNS, DHCP, TCP/IP, static IP configuration
- Help desk concepts and ticketing workflows
